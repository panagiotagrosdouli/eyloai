...
export const PERSONAS = {
  student: {
    ...
    examples: [
      ...
      'Find open-access papers for my thesis topic',
    ],
    ...
    quickLinks: [
      { label: 'Start a Literature Review', href: '/home' },
  ...
  masters: {
    ...
    examples: [
      ...
      'Compare recent methods used in my research area',
    ...
    quickLinks: [
      { label: 'Find Research Gaps', href: '/home' },
  ...
  phd: {
    ...
    examples: [
      ...
      'Find recent papers and active research groups in my area',
      'Identify research gaps in quantum ML',
      'Search current official funding calls for my topic',
      'Map adjacent research groups and evidence clusters',
    ],
    focusAreas: ['Novelty Evidence', 'Research Gaps', 'Literature', 'Funding', 'Collaborations'],
  ...
  professor: {
    ...
    examples: [
      ...
      'Discover researchers publishing in my field',
  ...
  founder: {
    ...
    examples: [
      'Map the research evidence around my healthtech idea',
      'Find current official commercialization funding calls',
      'Build my startup team from research',
      'Find current official deep-tech funding opportunities',
      'Build a market-validation plan for my product assumptions',
    ],
    focusAreas: ['Evidence Mapping', 'Funding Discovery', 'Team Building', 'Startup Strategy', 'Validation'],
  ...
  organization: {
    ...
    examples: [
      ...
      'Map the published research landscape in our sector',
    ],
