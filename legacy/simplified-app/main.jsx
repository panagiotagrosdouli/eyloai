  ...
  return (
    <div className="app-shell">
      <header className="site-header">
        <a className="brand" href="#top" aria-label="EYLO home">
        ...
        <a className="button button-small" href="https://github.com/panagiotagrosdouli/eyloai">
          View GitHub
        </a>
      </header>
      ...
      <main id="top">
        <section className="hero" aria-labelledby="hero-title">
          ...
          <div className="hero-actions">
            ...
            <a className="button button-secondary" href="#open-source">Open-source roadmap</a>
          </div>
        ...
        <section className="section open-source" id="open-source" aria-labelledby="oss-title">
          <div>
            ...
            <p>
              The repository is the foundation for an open, extensible platform.
              Contributions should favor clear interfaces, testable behavior, accessibility,
              secure defaults, and documentation that distinguishes implemented features
